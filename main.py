...
def test_banking_scenario():
    ...
    print(account_use_case.create_account(1, 'Andrew', 'abc@gmail.com', '12345678'))
    print(account_use_case.create_account(1, 'Halaand', 'sss@gmail.com', '12345678'))
    print(account_use_case.create_account(2, 'Jacob', 'abcsad@gmail.com', '12345678'))
